...
export default function TrackDetailsStep({audioFile, handleClose}) {
    ...
    const handleUpload = async (audioFile, coverFile, artistName, songTitle, isPublic) => {
        if (!audioFile) return;
        try {
            await uploadMusic(
                audioFile,
    ...
    return (
        ...
        >
            <div
                className={styles.audioFileInfo}
            >
            ...
            <button
                ...
                onClick={() => handleUpload(audioFile, coverFile, artistName, songTitle, isPublic, handleClose)}
            >
                Upload
            </button>
