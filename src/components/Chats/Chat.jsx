        ...
        <div className={styles.chatInfo}>
          <div className={styles.chatInfoWrapper}>
            <div className={styles.chatIconContainer}>
              <img src={chatPic} alt="avatarPic" className={styles.chatPic} />
              {isOnline ? '' : ''}
              {/*<img src={isOnline ? "" : ""} alt="isOnlineDot"/>*/}
            </div>

            <div className={styles.chatTitleContainer}>
              <span className={styles.chatUserName}>{chatUserName}</span>
              <span className={styles.chatLastMessage}>{chatLastMessage}</span>
            </div>
          </div>
